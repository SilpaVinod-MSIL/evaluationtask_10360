class AppConstants {
  ...
  static int thirtyOneText = 31;
  static int twelveText = 12;
  static int fourText = 4;
  static int sixText = 6;
  static int nineText = 9;
  static int elevenText = 11;
  static int thirtyText = 30;
